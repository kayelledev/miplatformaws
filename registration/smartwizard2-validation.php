...
<link href="http://server.ashoresystems.com/~reelfund/registration/styles/smart_wizard.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="http://server.ashoresystems.com/~reelfund/registration/js/jquery-1.4.2.min.js"></script>
<script type="text/javascript" src="http://server.ashoresystems.com/~reelfund/registration/js/jquery.smartWizard-2.0.min.js"></script>
...
<!-- Tabs -->
  		<div id="wizard" class="swMain">
  			<ul>
                ...
                <span class="stepDesc">
                   Account Details<br />
                   <small>Fill your account details</small>                </span>
            </a></li>
  				<li><a href="#step-2">
                <span class="stepNumber">2</span>
                <span class="stepDesc">
                   Profile Details<br />
                   <small>Fill your profile details</small>                </span>
            </a></li>
  				<li><a href="#step-3">
                <span class="stepNumber">3</span>
                <span class="stepDesc">
                   Contact Details<br />
                   <small>Fill your contact details</small>                </span>
             </a></li>
  				<li><a href="#step-4">
                <span class="stepNumber">4</span>
                <span class="stepDesc">
                   Other Details<br />
                   <small>Fill your other details</small>                </span>
            </a></li>
  			</ul>
  			<div id="step-1">	
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                    	  <input type="password" id="password" name="password" value="" class="txtBox">                      </td>
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                            <textarea name="address" id="address" class="txtBox" rows="3"></textarea>                      </td>
            ...
            <table cellspacing="3" cellpadding="3" align="center">
          			...
          			<tr>
                    	...
                    	<td align="left">
                            <textarea name="address" id="address" class="txtBox" rows="5"></textarea>                      </td>
                    	<td align="left"><span id="msg_address"></span>&nbsp;</td>
          			</tr>                                   			
  			   </table>                 			
        </div>
